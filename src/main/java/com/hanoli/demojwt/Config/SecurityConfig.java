...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://shessmat-frontend.vercel.app","https://shessmat-frontend-git-develop-hans-projects-604cd50d.vercel.app","http://localhost:4200" )); // Solo tu frontend
